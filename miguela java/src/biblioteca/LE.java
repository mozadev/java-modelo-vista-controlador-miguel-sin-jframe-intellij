...
public class LE {
     ...
     * respectivamente. Si se cierra este cuadro de diálogo sin presionar algún
     * botón, retorna el entero -1.
     */
     ...
     * múltiples opciones.
     *
     * @param opciones es un arreglo de cadenas con las opciones a mostrar.
     ...
     *
     * @param opciones es un arreglo de cadenas con las opciones a mostrar.
     * @return un entero con la posición de la opción seleccionada. Si cierra la
     * ventana o cancela retorna -1.
     *
     */
